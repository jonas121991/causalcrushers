...
The first issue is the right selection into treatment. In real experiments, the selection into treatment is not random and can bias the results. Hence, it is important to control for confounders, which determine assignment to treatment and are correlated with the outcome.

The second challenge is the validity (external and internal) of the instrument. The effects of an instrument in an experiments can have a internal validity, but it is not clear if the effect can be transferred to other circumstances or other subgroups (external validity). 
